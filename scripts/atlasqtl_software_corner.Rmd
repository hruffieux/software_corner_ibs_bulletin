...
The material used in this example is available at https://github.com/hruffieux/software_corner_ibs_bulletin
for replication purposes. It involves synthetic genotyping data generated using 
our in-house R package `echoseq` available at 
...
share without data access agreement. The expression data consist of monocyte 
...
n_cpus <- 4 # please change this number according to your setup. `n_cpus <- 1` corresponds to a serial execution (e.g., needed for Windows users).
