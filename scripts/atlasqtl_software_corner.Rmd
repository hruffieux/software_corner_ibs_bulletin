...
https://github.com/hruffieux/atlasqtl#installation. Note that the GSL library 
must be installed prior to installing the package.

### Data and reproducibility

The material (incl. Rmarkdown document) used in the example below is available 
at https://github.com/hruffieux/software_corner_ibs_bulletin for replication 
purposes. It involves synthetic genotyping data generated using our in-house R 
package `echoseq`; these data emulate real genotypes (single nucleotide 
polymorphisms, "SNPs") located on chromosome 12 in the *LYZ* gene region. The 
...
package is available at https://github.com/hruffieux/epispot.
